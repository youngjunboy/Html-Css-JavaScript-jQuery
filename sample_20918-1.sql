...
(2, '김영선', '01036545856', '서울시 중구 소공로 123(충무로1가)', 'W', 35, 10000),
(3, '정기찬', '01089576430', '부산시 동래구 명륜로 123(명륜동, 명륜동 힐스테이트)', 'M', 25, 100),
(4, '박찬호', '01029757847', '광주시 남구 회재로 123(지석동, 지석동 한일베라체 아파트)', 'W', 30, 10000),
(5, '이상훈', '01035547846', '광주시 남구 도금마을길 123(도금동)', 'M', 27, 0),
(6, '장영진', '01043687490', '부산시 영도구 장미계단길 123(봉래동5가)', 'M', 35, 25000),
(7, '박용진', '01089576430', '서울시 은평구  은평로20길 123(응암동, 청송아파트)', 'W', 38, 10000),
(9, '김문영', '01054564755', '서울시 송파구 오금로 123(신천동)', 'W', 53, 12500),
(10, '차범수', '01004373432', '대전시 서구 둔산북로 123(둔산동)', 'W', 32, 10000),
...
(14, '유한나', '01030975412', '광주시 서구 염화로31번길 123(화정동)', 'W', 32, 10000),
...
(20, '김진모', '01039576411', '서울시 구로구 연동로 123(항동)', 'W', 35, 10000),
(21, '김영찬', '01099576433', '부산시 영도구 청학동로 123(청학동)', 'M', 59, 12500),
(22, '김재진', '01037573776', '서울시 중구  충무로 123(충무로3가)', 'W', 35, 10000),
...
(27, '박지은', '01038957643', '경상남도 거창군 거창읍 강양5길 123', 'W', 35, 10000),
